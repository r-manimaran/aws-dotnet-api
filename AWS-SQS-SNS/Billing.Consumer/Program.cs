    ...
    services.AddMassTransit(x =>
{
    ...
    x.UsingAmazonSqs((context, cfg) =>
    {
        ...
        cfg.ReceiveEndpoint("order-billing-queue", e =>
        {
            //Enable Raw message Delivery from SNS
            e.ConfigureConsumeTopology = false;

            e.ConfigureConsumer<BillingConsumer>(context);
...
Console.WriteLine("Billing Consumer is running..");
await host.RunAsync();
